...
const STORE_SETTING_KEY = 'AO3PB_SETTINGS'
const STORE_SETTING_EXTRA_BTN_KEY = 'AO3PB_SETTING_EXTRA_BTN'
const STORE_SETTING_PU_KEY = 'AO3PB_SETTING_PU'
const STORE_SETTING_PU_UI_KEY = 'AO3PB_SETTING_PU_UI'

const STORE_WORK_KEY_PREFIX = `AO3PB`
const STORE_ALL_WORK_KEYS = `AO3PB_ALL_WORK_KEYS`
...
export {
  ...
  DEFAULT_SETTINGS, DEFAULT_SETTING_EXTRA_BUTTONS, DEFAULT_SETTING_PU, DEFAULT_SETTING_PU_UI,
