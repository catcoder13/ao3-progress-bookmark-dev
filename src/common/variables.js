...
const STORE_SETTING_EXTRA_BTN_KEY = 'AO3_IPB_SETTING_EXTRA_BTN'
const STORE_SETTING_PU_KEY = 'AO3_IPB_SETTING_PU'
const STORE_SETTING_PU_UI_KEY = 'AO3_IPB_SETTING_PU_UI'
